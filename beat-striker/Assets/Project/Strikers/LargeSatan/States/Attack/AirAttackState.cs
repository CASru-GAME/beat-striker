        ...
        public override void OnEnter(IStrikerContext context) {
            ...
            attackPlayer.OnHit
                .Subscribe(hit => {
                    ...
                    var dir = (hit.Position - context.GetSelf().CenterPosition.CurrentValue).normalized;
                    var hitStatus = new HitStatus(damage, nockbackSpeed * (dir.y < 0.5f ? Vector3.down : dir));
